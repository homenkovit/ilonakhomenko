		...
		topics: [
			...
			},
			{
				...
				items: [
					...
					"Пограничные и биполярные расстройства (ПРЛ и БАР).",
		...
		topics: [
			{
				...
				items: [
					...
					"Self-exploration and selecting supportive practices that are right for you.",
			...
			},
			{
				...
				items: [
					"Decreased self-esteem and changes in self-perception after losing previous status.",
			...
			},
			{
				...
				items: [
					...
					"Social anxiety.",
					"Heightened anxiety as a personality trait.",
			...
			{
				title: "Existential questions and search for meaning",
				items: [
					"If you feel lost, don't understand which direction to move in, what you want to do, or where to go next, we can gently explore these questions together.",
				],
			},
			{
			...
			},
			{
				...
				items: [
					...
					"Psychological support and accompaniment during the grieving process.",
				],
			},
			{
				title: "Other topics",
				items: [
					"If you're unsure whether I work with a particular concern, you can message me on Telegram, email me, or clarify during the first consultation.",
				],
			},
			{
				...
				items: [
					...
					"Borderline and bipolar disorders (BPD and BD).",
			...
			},
			{
				...
				items: [
					"I work in a psychological counseling and support format.",
					"I do not diagnose or prescribe medication. If you are undergoing treatment and notice changes in your wellbeing or emotional state, it's important to discuss these with your treating physician or another relevant specialist.",
					"I do not use esoteric or occult practices in my work.",
					"If you have pronounced physical symptoms or health complaints, it's important to see a doctor and not replace specialist consultations with counseling.",
					"If you notice that your condition is worsening or it's becoming difficult to cope on your own, it's important to seek additional professional help in a timely manner.",
				],
			},
		],
		disclaimer:
