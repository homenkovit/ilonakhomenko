...
- excess activity in the amygdala in response to stress, which puts you on constant guard "just in case." The prefrontal cortex struggles more with emotional regulation as a result;
- your life history. If you grew up in a high-expectations environment and were sensitive to earning approval, this may have become a coping strategy — one that's now misfiring;
- strange as it sounds, simply habit. You've become so accustomed to responding this way that it has become your default mode — a closed loop. Can it be changed? Of course.
...
If you've tried the techniques described above and they still haven't helped, and this is interfering with your quality of life — a psychologist or therapist can listen to your life story and explore whether your state might be driven by something else. In some cases, medication support may be needed — and that's nothing to be afraid of.
